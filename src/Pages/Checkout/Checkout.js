...
function Checkout() {
    ...
    const handlePlaceOrder = event => {
        ...
        .then(response =>{
            const {data} = response;
            if(data.insertedId){
                toast.success("Your order is booked. Our representative will contact with you soon.");
                event.target.reset();
            }
    ...
    return (
        <div className='w-50 mx-auto'>
            ...
            <form onSubmit={handlePlaceOrder}>
                ...
                <br />
                <input className='w-100 mb-2' value={service.name} type="text" name='service' placeholder='Service Title' required readOnly />
                <br />
